  ...
  settings: [
    {
      ...
      site: {
        name: 'Botcellar',
        description:
          'Botcellar is a sample Ecommerce website built with Next.js, Tailwind CSS, and MongoDB.',
        keywords: 'Next Ecommerce, Next.js, Tailwind CSS, MongoDB',
        url: 'https://nextjs-botcellar.vercel.app',
        logo: '/icons/logo.svg',
        slogan: 'Spend less, enjoy more.',
        author: 'Next Ecommerce',
        copyright: '2000-2025, Next-Ecommerce.com, Inc. or its affiliates',
        email: 'admin@example.com',
